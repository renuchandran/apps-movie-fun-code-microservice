...
public class MovieServlet extends HttpServlet {
    ...
    @Value("${movies.environment}") String moviesEnv;
    ...
    private void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("Add".equals(action)) {
            ...
            System.out.println("Movie Servlet Add Movie Start");
            if(moviesClient.movieFunServiceError.isEmpty()){
            	moviesClient.addMovie(movie);	
            }else{
            	request.setAttribute("movieFunServiceError", moviesClient.movieFunServiceError);
            	moviesClient.movieFunServiceError=moviesClient.EMPTY;
            }
            System.out.println("Movie Servlet Add Movie End");
        ...
        request.setAttribute("moviesEnv", moviesEnv);
